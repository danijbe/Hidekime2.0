...
var RegisterPage = (function () {
    ...
    RegisterPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* MenuController */], __WEBPACK_IMPORTED_MODULE_2__providers_database_database__["a" /* DatabaseProvider */]])
    ], RegisterPage);
    return RegisterPage;
}());
...
var ProfilePage = (function () {
    function ProfilePage(navCtrl, navParams, alertCtrl, idService, database) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    ProfilePage.prototype.update = function () {
        ...
        if (this.newUsername != null || this.newUsername != undefined) {
            this.database.updateUsername(this.id, this.newUsername).then(function (data) {
                for (var i in data) {
                    ...
                    var alert = _this.alertCtrl.create({
                        ...
                        subTitle: 'Tu nombre de usuario ha sido cambiado por: ' + _this.newUsername,
                        buttons: ['OK']
                    });
                    alert.present();
                }
            ...
            this.database.updatePassword(this.id, this.newPass).then(function (data) {
                for (var i in data) {
                    var alert = _this.alertCtrl.create({
                        title: 'Cambio de password',
                        subTitle: 'Tu password ha sido cambiada por: ' + _this.newPass,
                        buttons: ['OK']
                    });
                    alert.present();
                }
...
var DatabaseProvider = (function () {
    ...
    DatabaseProvider.prototype.updateUsername = function (id, user) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.db.executeSql("UPDATE usuario  SET nombre=? WHERE id=?", [user, id]).then(function (data) {
                resolve(data);
            }, function (error) {
                reject(error);
            });
    ...
    DatabaseProvider.prototype.updatePassword = function (id, pass) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.db.executeSql("UPDATE usuario  SET contrasenia=? WHERE id=?", [pass, id]).then(function (data) {
                var change = [];
                if (data.rows.length > 0) {
                    for (var i = 0; i < data.rows.length; i++) {
                        change.push({
        ...
        return new Promise(function (resolve, reject) {
            _this.db.executeSql("SELECT id,nombre FROM temporada", []).then(function (data) {
                ...
                var _loop_1 = function () {
                    var name = data.rows.item(i).nombre;
                    console.log(name);
    ...
    DatabaseProvider = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_native_sqlite__["a" /* SQLite */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_native_sqlite__["a" /* SQLite */]) === "function" && _b || Object])
    ], DatabaseProvider);
...
var LogInPage = (function () {
    ...
    LogInPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_5__providers_idService_idService__["a" /* idService */], __WEBPACK_IMPORTED_MODULE_2__providers_database_database__["a" /* DatabaseProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* MenuController */]])
    ], LogInPage);
    return LogInPage;
}());
